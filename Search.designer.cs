...
namespace Login1
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Price")]
    ...
    partial void DeletetblProduct(tblProduct instance);
		...
		public SearchDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["PriceConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
